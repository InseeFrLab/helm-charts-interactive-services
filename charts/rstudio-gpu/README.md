...
![Version: 1.15.26](https://img.shields.io/badge/Version-1.15.26-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
* <https://github.com/InseeFrLab/helm-charts-interactive-services/tree/main/charts/rstudio-gpu>
...
| service.image.custom.version | string | `"inseefrlab/onyxia-rstudio:r4.4.0-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-rstudio:r4.4.0-gpu"` |  |
