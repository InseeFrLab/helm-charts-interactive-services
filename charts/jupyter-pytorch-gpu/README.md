...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-pytorch:py3.12.2-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-pytorch:py3.12.2-gpu"` |  |
