...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-pytorch:py3.13.13-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-pytorch:py3.13.13-gpu"` |  |
