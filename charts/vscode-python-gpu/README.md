...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-python:py3.10.13-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-python:py3.10.13-gpu"` |  |
