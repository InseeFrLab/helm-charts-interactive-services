...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-python:py3.13.15-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-python:py3.13.15-gpu"` |  |
