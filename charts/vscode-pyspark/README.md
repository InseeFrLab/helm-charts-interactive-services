...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-pyspark:py3.13.11-spark4.0.1"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-pyspark:py3.13.11-spark4.0.1"` |  |
