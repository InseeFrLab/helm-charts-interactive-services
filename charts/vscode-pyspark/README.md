...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-pyspark:py3.12.11-spark3.5.5"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-pyspark:py3.12.11-spark3.5.5"` |  |
