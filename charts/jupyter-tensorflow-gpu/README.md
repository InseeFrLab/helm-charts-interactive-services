...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-tensorflow:py3.13.8-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-tensorflow:py3.13.8-gpu"` |  |
