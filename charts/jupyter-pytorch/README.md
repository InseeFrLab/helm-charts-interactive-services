...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-pytorch:py3.10.13"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-pytorch:py3.10.13"` |  |
