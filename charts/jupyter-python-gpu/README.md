...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-python:py3.12.11-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-python:py3.12.11-gpu"` |  |
