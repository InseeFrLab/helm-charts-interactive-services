...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-pyspark:py3.12.4-spark3.5.2"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-pyspark:py3.12.4-spark3.5.2"` |  |
