...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-r-python-julia:r4.3.3"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-r-python-julia:r4.3.3"` |  |
