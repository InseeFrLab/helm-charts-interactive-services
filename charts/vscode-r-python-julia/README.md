...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-r-python-julia:r4.5.0-py3.13.5"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-r-python-julia:r4.5.0-py3.13.5"` |  |
