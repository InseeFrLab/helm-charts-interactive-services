...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-pytorch:py3.11.6-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-pytorch:py3.11.6-gpu"` |  |
