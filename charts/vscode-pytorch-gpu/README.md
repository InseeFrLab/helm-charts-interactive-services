...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-pytorch:py3.13.13-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-pytorch:py3.13.13-gpu"` |  |
