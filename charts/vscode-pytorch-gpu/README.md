...
| service.image.custom.version | string | `"inseefrlab/onyxia-vscode-pytorch:py3.12.4-gpu"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-vscode-pytorch:py3.12.4-gpu"` |  |
