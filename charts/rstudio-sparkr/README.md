...
![Version: 1.17.8](https://img.shields.io/badge/Version-1.17.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| service.image.custom.version | string | `"inseefrlab/onyxia-rstudio-sparkr:r4.3.2-spark3.5.0"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-rstudio-sparkr:r4.3.2-spark3.5.0"` |  |
