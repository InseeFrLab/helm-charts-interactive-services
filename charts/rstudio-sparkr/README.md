...
![Version: 1.17.15](https://img.shields.io/badge/Version-1.17.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| service.image.custom.version | string | `"inseefrlab/onyxia-rstudio-sparkr:r4.4.0-spark3.5.1"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-rstudio-sparkr:r4.4.0-spark3.5.1"` |  |
