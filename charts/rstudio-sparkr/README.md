...
| service.image.custom.version | string | `"inseefrlab/onyxia-rstudio-sparkr:r4.6.1-spark4.1.1"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-rstudio-sparkr:r4.6.1-spark4.1.1"` |  |
