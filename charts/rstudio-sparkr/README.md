...
| service.image.custom.version | string | `"inseefrlab/onyxia-rstudio-sparkr:r4.5.1-spark3.5.6"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-rstudio-sparkr:r4.5.1-spark3.5.6"` |  |
